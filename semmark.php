...
if(!empty($gmail) && !empty($semmark) && !is_numeric($gmail))
{
    $query="insert into semmark (name,email,semmark)  values('$name','$gmail','$semmark')";
