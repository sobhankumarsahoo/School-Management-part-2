<?php
    ...
    {
        $query="insert into teacher (teacherid,name,email,subject,password)  values('   $id',' $name','$email','$subject',' $password')";
...
<body>
        ...
        <table class="center" border="2">
            <tr><th colspan="2">TEACHER REGISTER</th><TH></TH></tr>
            <tr><th>Teacher_id</th><th><input type="text" name="id" required></th></tr>
            <tr><th>Name</th><th><input type="text" name="name" required></th></tr>
            <tr><th>Email</th><th><input type="email" name="mail" required></th></tr>
            <tr><th>Subject</th><th><input type="text" name="subject" required></th></tr>
